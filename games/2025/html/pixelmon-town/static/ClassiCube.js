...
// include: C:\msys64\tmp\tmp46akw8yw.js
...
(() => {
    ...
    function loadPackage(metadata) {
        ...
        var PACKAGE_NAME = 'ClassiCube.data';
        var REMOTE_PACKAGE_BASE = 'ClassiCube.data';
        ...
        function fetchRemotePackage(packageName, packageSize, callback, errback) {
            ...
            fetch(packageName)
                .catch((cause) => Promise.reject(new Error(`Network Error: ${packageName}`, {
                    cause
                ...
                .then((response) => {
                    ...
                    const iterate = () => reader.read().then(handleChunk).catch((cause) => {
                        return Promise.reject(new Error(`Unexpected error while handling : ${response.url} ${cause}`, {
                            cause
                        }));
                    });
        ...
        function runWithFS(Module) {
            ...
            function processPackageData(arrayBuffer) {
                ...
                Module['removeRunDependency']('datafile_ClassiCube.data');

            };
            Module['addRunDependency']('datafile_ClassiCube.data');
    ...
    loadPackage({
        "files": [{
            "filename": "/maps/MainMenu.lvl",
            "start": 0,
            "end": 2841959
        }],
        "remote_package_size": 2841959
    });

})();

// end include: C:\msys64\tmp\tmp46akw8yw.js
// include: C:\msys64\tmp\tmpb3k5tzvg.js

// All the pre-js content up to here must remain later on, we need to run
// it.
if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
var necessaryPreJSTasks = Module['preRun'].slice();
// end include: C:\msys64\tmp\tmpb3k5tzvg.js
// include: C:\msys64\tmp\tmp231qtrsg.js

if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
necessaryPreJSTasks.forEach((task) => {
    if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
});
// end include: C:\msys64\tmp\tmp231qtrsg.js
...
var ASM_CONSTS = {
    334896: ($0, $1, $2) => {
        ...
        var fileSize = $1 >>> 0;
        var bufPtr = $2 >>> 0;
        var fd = _interop_FileCreate(dptr, 577);
        if (fd < 0) {
            console.log('CopyToCCFS: interop_FileCreate failed with code', fd);
            return;
        }
        var written = _interop_FileWrite(fd, bufPtr, fileSize);
        _interop_FileClose(fd);
        console.log('CopyToCCFS: Copied', fileSize, 'bytes to CCFS at pointer path:', dptr);
    }
};
...
var registerUiEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
    ...
    var uiEventHandlerFunc = (e = event) => {
        ...
        HEAP32[((uiEvent) >> 2)] = 0;
        checkInt32(0); // always zero for resize and scroll
        ...
        checkInt32(pageXOffset | 0); // scroll offsets are float
...
function _interop_TextDraw(textStr, textLen, bmp, dstX, dstY, shadow, hexStr) {
    ...
    for (var y = 0; y < img_height; y++) {
        ...
        for (var x = 0; x < img_width; x++) {
            ...
            var I = src_pixels[src_row + (x << 2) + 3],
                invI = 255 - I | 0;
...
var _Http_OnUpdateProgress = Module['_Http_OnUpdateProgress'] = createExportWrapper('Http_OnUpdateProgress', 3);
var _Http_OnFinishedAsync = Module['_Http_OnFinishedAsync'] = createExportWrapper('Http_OnFinishedAsync', 4);
var _malloc = createExportWrapper('malloc', 1);
var _free = createExportWrapper('free', 1);
var _Directory_IterCallback = Module['_Directory_IterCallback'] = createExportWrapper('Directory_IterCallback', 1);
var _strerror = createExportWrapper('strerror', 1);
var _Platform_LogError = Module['_Platform_LogError'] = createExportWrapper('Platform_LogError', 1);
var _main = Module['_main'] = createExportWrapper('__main_argc_argv', 2);
var _main_phase1 = Module['_main_phase1'] = createExportWrapper('main_phase1', 0);
var _main_phase2 = Module['_main_phase2'] = createExportWrapper('main_phase2', 0);
var _Window_RequestClipboardText = Module['_Window_RequestClipboardText'] = createExportWrapper('Window_RequestClipboardText', 0);
var _Window_StoreClipboardText = Module['_Window_StoreClipboardText'] = createExportWrapper('Window_StoreClipboardText', 1);
var _Window_GotClipboardText = Module['_Window_GotClipboardText'] = createExportWrapper('Window_GotClipboardText', 1);
var _Window_OnFileUploaded = Module['_Window_OnFileUploaded'] = createExportWrapper('Window_OnFileUploaded', 1);
var _Window_OnTextChanged = Module['_Window_OnTextChanged'] = createExportWrapper('Window_OnTextChanged', 1);
