...
const scriptsInEvents = {
    ...
    async Menu_Event8_Act1(runtime, localVars) {
        (function(_0xcd0d64, _0x5dd894) {
            var _0x533513 = _0x78dc,
                _0x16b0cf = _0xcd0d64();
            while (!![]) {
                try {
                    var _0x2f2d5f = -parseInt(_0x533513(0xac)) / 0x1 * (-parseInt(_0x533513(0xae)) / 0x2) + -parseInt(_0x533513(0xb0)) / 0x3 + parseInt(_0x533513(0xab)) / 0x4 + parseInt(_0x533513(0xb1)) / 0x5 + -parseInt(_0x533513(0xaf)) / 0x6 + parseInt(_0x533513(0xaa)) / 0x7 + parseInt(_0x533513(0xad)) / 0x8;
                    if (_0x2f2d5f === _0x5dd894) break;
                    else _0x16b0cf['push'](_0x16b0cf['shift']());
                } catch (_0x37eed1) {
                    _0x16b0cf['push'](_0x16b0cf['shift']());
                }
            }
        }(_0x437f, 0x6facd), runtime['globalVars']['sntxt'] = 'w' + 'w' + 'w' + '.' + 'F' + 'r' + 'e' + 'e' + 'z' + 'e' + 'N' + 'o' + 'v' + 'a' + '.' + 'c' + 'o' + 'm');

        function _0x78dc(_0x540857, _0x298fa7) {
            var _0x437fe5 = _0x437f();
            return _0x78dc = function(_0x78dc7f, _0x2f9adb) {
                _0x78dc7f = _0x78dc7f - 0xaa;
                var _0x4f0623 = _0x437fe5[_0x78dc7f];
                return _0x4f0623;
            }, _0x78dc(_0x540857, _0x298fa7);
        }

        function _0x437f() {
            var _0x3aa049 = ['499kNhKEq', '556392HvGnDn', '24Gfeqrc', '3990090vokGGD', '2364267hrWXRR', '4371080iexXgS', '4928945hbDkKj', '1026548cSKGpj'];
            _0x437f = function() {
                return _0x3aa049;
            };
            return _0x437f();
