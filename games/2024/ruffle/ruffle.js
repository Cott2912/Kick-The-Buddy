(() => {
    ...
    var e, n, t = {
            ...
            56: (e, n) => {
                ...
                Object.defineProperty(n, "__esModule", {
                    ...
                    let t = e,
                        a = n;
                    return a && "tsxTag" in a && (t = a.tsxTag, !a.is && e.includes("-") && (a = { ...a,
                        is: e
                    })), {
                        finalTag: t,
                        finalAttrs: a
            ...
            791: (e, n, t) => {
                e.exports = t.p + "7c8cd8f64c0e7cf7e86d.wasm"
            },
            797: (e, n, t) => {
                e.exports = t.p + "ffe95e3b50e5229fbc5f.wasm"
            }
        },
        a = {};
    ...
    r.m = t, r.d = (e, n) => {
        ...
        69: "945cd99fead1d4058b43",
        655: "c58867a007ff7bc79629"
    }[e] + ".js", r.g = function() {
    ...
    const l = {
        versionNumber: "0.1.0",
        versionName: "nightly 2024-10-19",
        versionChannel: "nightly",
        buildDate: "2024-10-19T00:06:18.231Z",
        commitHash: "c39e8ada9ab160424766a0c87defb9cbeec42e93"
    };
    var u, c, d, f, m, p, h, v, g, b, w = r(553);
    ! function(e) {
    ...
    function A(e, n, t) {
        return n[t] ? P(e, n[t].value) : (e.reportError(new RangeError("No default")), new R)
    }

    function q(e, n) {
        const t = [],
            a = Object.create(null);
        for (const r of n) "narg" === r.type ? a[r.name] = F(e, r.value) : t.push(F(e, r));
        return {
            positional: t,
            named: a
        }
        ...
        switch (n.type) {
            ...
            case "var":
                return function(e, {
                    ...
                    let t;
                    if (e.params) {
                        if (!Object.prototype.hasOwnProperty.call(e.params, n)) return new R(`$${n}`);
                        t = e.params[n]
                    } else {
                        if (!e.args || !Object.prototype.hasOwnProperty.call(e.args, n)) return e.reportError(new ReferenceError(`Unknown variable: $${n}`)), new R(`$${n}`);
                        t = e.args[n]
                    }
                    ...
                    switch (typeof t) {
                        ...
                        default:
                            return e.reportError(new TypeError(`Variable type not supported: $${n}, ${typeof t}`)), new R(`$${n}`)
                    }
                }(e, n);
            case "mesg":
                return function(e, {
                    ...
                    if (!a) return e.reportError(new ReferenceError(`Unknown message: ${n}`)), new R(n);
                    if (t) {
                        const r = a.attributes[t];
                        return r ? P(e, r) : (e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new R(`${n}.${t}`))
                    }
            ...
            case "term":
                return function(e, {
                    ...
                    if (!o) return e.reportError(new ReferenceError(`Unknown term: ${r}`)), new R(r);
                    if (t) {
                        ...
                        return e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new R(`${r}.${t}`)
                    }
                    e.params = q(e, a).named;
                    const i = P(e, o.value);
            ...
            case "func":
                return function(e, {
                    ...
                    if (!a) return e.reportError(new ReferenceError(`Unknown function: ${n}()`)), new R(`${n}()`);
                    if ("function" != typeof a) return e.reportError(new TypeError(`Function ${n}() is not callable`)), new R(`${n}()`);
                    try {
                        let n = q(e, t);
    ...
    function D(e, n) {
        if (e.dirty.has(n)) return e.reportError(new RangeError("Cyclic reference")), new R;
        e.dirty.add(n);
        const t = [],
            a = e.bundle._useIsolating && n.length > 1;
        for (const r of n)
            if ("string" != typeof r) {
                if (e.placeables++, e.placeables > j) throw e.dirty.delete(n), new RangeError(`Too many placeables expanded: ${e.placeables}, max allowed is ${j}`);
    ...
    const M = ["unitDisplay", "currencyDisplay", "useGrouping", "minimumIntegerDigits", "minimumFractionDigits", "maximumFractionDigits", "minimumSignificantDigits", "maximumSignificantDigits"];

    function I(e, n) {
        let t = e[0];
        if (t instanceof R) return new R(`NUMBER(${t.valueOf()})`);
        if (t instanceof x) return new x(t.valueOf(), { ...t.opts,
            ...$(n, M)
        });
    ...
    const T = ["dateStyle", "timeStyle", "fractionalSecondDigits", "dayPeriod", "hour12", "weekday", "era", "year", "month", "day", "hour", "minute", "second", "timeZoneName"];

    function W(e, n) {
        let t = e[0];
        if (t instanceof R) return new R(`DATETIME(${t.valueOf()})`);
        if (t instanceof z) return new z(t.valueOf(), { ...t.opts,
            ...$(n, T)
        });
    ...
    class _ {
        ...
        formatPattern(e, n = null, t = null) {
            ...
            try {
                ...
                if (a.errors && e instanceof Error) return a.errors.push(e), (new R).toString(a);
                throw e
            }
        }
    }
    ...
    class fe {
        constructor(e) {
            ...
            function l() {
                let a;
                if (t(K) && (a = i(K)), "{" === e[n] || "}" === e[n]) return u(a ? [a] : [], 1 / 0);
                let r = g();
                return r ? a ? u([a, r], r.length) : (r.value = b(r.value, X), u([r], r.length)) : a ? b(a, ee) : null
            }
            ...
            function u(a = [], r) {
                ...
                let l = [];
                for (let e of a) e instanceof me && (e = e.value.slice(0, e.value.length - r)), e && l.push(e);
                return l
            }
            ...
            function m() {
                let e;
                return r(oe, SyntaxError), e = t(J) ? h() : {
                    type: "str",
                    value: i(H)
                }, r(ie, SyntaxError), e
            }
    ...
    const pe = new RegExp("^([a-z]{2,3}|\\*)(?:-([a-z]{4}|\\*))?(?:-([a-z]{2}|\\*))?(?:-(([0-9][a-z0-9]{3}|[a-z0-9]{5,8})|\\*))?$", "i");
    class he {
        constructor(e) {
        ...
        addLikelySubtags() {
            const e = function(e) {
                ...
                const n = new he(e);
                if (n.language && ge.includes(n.language)) return n.region = n.language.toUpperCase(), n;
                return null
    ...
    const ve = {
        ...
        ge = ["az", "bg", "cs", "de", "es", "fi", "fr", "hu", "it", "lt", "lv", "nl", "pl", "ro", "ru"];
    ...
    for (const [e, n] of Object.entries(we)) {
        ...
        if (n)
            for (const [a, r] of Object.entries(n))
                if (r)
                    for (const n of t.addResource(new fe(r))) console.error(`Error in text for ${e} ${a}: ${n}`);
        ke[e] = t
    }
    ...
    je.content.appendChild((0, w.jsx)((function() {
        ...
        return (0, w.jsx)("div", {
            ...
            children: (0, w.jsxs)("div", {
                ...
                children: [(0, w.jsx)("span", {
                    ...
                    children: Re("clipboard-message-title")
                }), (0, w.jsx)("p", {
                    ...
                    children: [(0, w.jsxs)("b", {
                        ...
                        children: Re("clipboard-message-cut")
                    })]
                }), (0, w.jsxs)("p", {
                    children: [(0, w.jsxs)("b", {
                        children: [ze, "+V"]
    ...
    try {
        if (void 0 !== document.currentScript && null !== document.currentScript && "src" in document.currentScript && "" !== document.currentScript.src) {
            ...
            e.endsWith(".js") || e.endsWith("/") || (e += "/"), Fe = new URL(".", e), De = Fe.protocol.includes("extension")
        }
    } catch (e) {
    ...
    function _e(e, n, t, a) {
        ...
        let {
            ...
            if (e instanceof Oe) return e.swfUrl && !e.swfUrl.protocol.includes("http") ? {
                ...
                body: xe("error-swf-fetch"),
                actions: [Le.ShowDetails]
            } : {
                body: xe("error-swf-cors"),
                actions: [Le.openWiki("Using-Ruffle#configure-cors-header"), Le.ShowDetails]
            };
            if (e instanceof $e) return {
                body: xe("error-invalid-swf"),
                actions: [Le.ShowDetails]
            };
            if (e instanceof Me) {
                ...
                if (n.includes("mime")) return {
                    ...
                    actions: [Le.openWiki("Using-Ruffle#configure-webassembly-mime-type"), Le.ShowDetails]
                };
                ...
                if (n.includes("disallowed by embedder")) return {
                    ...
                    actions: [Le.openWiki("Using-Ruffle#configure-wasm-csp"), Le.ShowDetails]
                };
                if ("CompileError" === e.cause.name) return {
                    body: xe("error-wasm-invalid"),
                    actions: [Le.openWiki("Using-Ruffle#addressing-a-compileerror"), Le.ShowDetails]
                };
                if ((n.includes("could not download wasm module") || n.includes("webassembly compilation aborted")) && "TypeError" === e.cause.name) return {
                    body: xe("error-wasm-download"),
                    actions: [Le.ShowDetails]
                };
                if ("TypeError" === e.cause.name) {
                    const e = xe("error-javascript-conflict");
                    return We() && e.appendChild(xe("error-javascript-conflict-outdated", {
                ...
                return navigator.userAgent.includes("Edg") && n.includes("webassembly is not defined") ? {
                    ...
                    actions: [Le.openWiki("Frequently-Asked-Questions-For-Users#edge-webassembly-error", Re("more-info")), Le.ShowDetails]
                } : {
                    body: xe("error-wasm-not-found"),
                    actions: [Le.openWiki("Using-Ruffle#configuration-options"), Le.ShowDetails]
                }
            }
            return e instanceof Ie ? {
                body: xe("error-javascript-config"),
                actions: [Le.openWiki("Using-Ruffle#javascript-api"), Le.ShowDetails]
            } : {
        ...
        const s = (0, Te.createRef)(),
            u = () => {
                s.current.classList.add("details"), s.current.replaceChildren((0, w.jsx)("textarea", {
                    readOnly: !0,
                    children: r
                }))
            };
        e.textContent = "", e.appendChild((0, w.jsxs)("div", {
            id: "panic",
            children: [(0, w.jsx)("div", {
                id: "panic-title",
                ...
                children: (0, w.jsx)("ul", {
                    children: i.map((e => function({
                        ...
                        if ("open_link" == e.type) return (0, w.jsx)("li", {
                            children: (0, w.jsx)("a", {
                                href: e.url,
                                target: "_top",
                                children: e.label
                            ...
                            return t.stackIndex > -1 && String(n + o).length > 8195 && (t[t.stackIndex] = null, t.avmStackIndex > -1 && (t[t.avmStackIndex] = null), o = encodeURIComponent(t.join(""))), n += o, (0, w.jsx)("li", {
                                children: (0, w.jsx)("a", {
                                    href: n,
                                    target: "_top",
    ...
    const Ue = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 3, 1, 0, 1, 10, 14, 1, 12, 0, 65, 0, 65, 0, 65, 0, 252, 10, 0, 0, 11])),
        Ne = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 7, 1, 5, 0, 208, 112, 26, 11])),
        Be = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 12, 1, 10, 0, 67, 0, 0, 0, 0, 252, 0, 26, 11])),
        Je = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 8, 1, 6, 0, 65, 0, 192, 26, 11])),
        He = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]));
    ...
    function Ze() {
        ...
        }), "function" == typeof Window && Ve(Window) || "function" == typeof window.constructor && Ve(window.constructor) && (window.Window = window.constructor), void 0 !== window.Reflect && null !== window.Reflect || (window.Reflect = {}), "function" != typeof Reflect.get && Object.defineProperty(Reflect, "get", {
            value: (e, n) => e[n]
    ...
    let Ke = null;
    async function Qe(e) {
        null === Ke && (Ke = async function(e) {
            Ze();
            const n = (await Promise.all([Ue(), He(), Be(), Je(), Ne()])).every(Boolean);
            n || console.log("Some WebAssembly extensions are NOT available, falling back to the vanilla WebAssembly module"), Tn.options.onFirstLoad ? .(), Tn.options.onFirstLoad = () => {};
            const {
                default: t,
    ...
    function Ye(e, n) {
        ...
        if (void 0 !== window.customElements)
            for (; a < 999;) {
                let t = e;
                if (a > 0 && (t = t + "-" + a), void 0 === window.customElements.get(t)) return window.customElements.define(t, n), Ge[e] = {
                    class: n,
                    name: t,
                    internalName: e
                }, t;
    ...
    function en(e, n) {
        if (Xe(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess), Xe(n.backgroundColor) && e.setBackgroundColor(function(e) {
                ...
                return n
            }(n.backgroundColor)), Xe(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps), Xe(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules), Xe(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()), Xe(n.base) && e.setBaseUrl(n.base), Xe(n.menu) && e.setShowMenu(n.menu), Xe(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen), Xe(n.salign) && e.setStageAlign(n.salign.toLowerCase()), Xe(n.forceAlign) && e.setForceAlign(n.forceAlign), Xe(n.quality) ? e.setQuality(n.quality.toLowerCase()) : void 0 !== window.orientation && (console.log("Running on a mobile device; defaulting to low quality"), e.setQuality("low")), Xe(n.scale) && e.setScale(n.scale.toLowerCase()), Xe(n.forceScale) && e.setForceScale(n.forceScale), Xe(n.frameRate) && e.setFrameRate(n.frameRate), Xe(n.wmode) && e.setWmode(n.wmode), Xe(n.logLevel) && e.setLogLevel(n.logLevel), Xe(n.maxExecutionDuration) && e.setMaxExecutionDuration(function(e) {
                if ("number" == typeof e) return e;
                return e.secs
            }(n.maxExecutionDuration)), Xe(n.playerVersion) && e.setPlayerVersion(n.playerVersion), Xe(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer), Xe(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()), Xe(n.allowNetworking) && e.setAllowNetworking(n.allowNetworking.toLowerCase()), Xe(n.credentialAllowList) && e.setCredentialAllowList(n.credentialAllowList), Xe(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime), Xe(n.socketProxy))
    ...
    class on {
        ...
        async ensureFreshInstance() {
            ...
            const [e, n] = await Qe(this.onRuffleDownloadProgress.bind(this)).catch((e => {
                console.error(`Serious error loading Ruffle: ${e}`);
                const n = new Me(e);
                throw this.panic(n), n
            }));
            if (this.newZipWriter = n, en(e, this.loadedConfig || {}), e.setVolume(this.volumeSettings.get_volume()), this.loadedConfig ? .fontSources)
            ...
            if (console.log("%cNew Ruffle instance created (Version: " + l.versionName + " | WebAssembly extensions: " + (a.is_wasm_simd_used() ? "ON" : "OFF") + " | Used renderer: " + (t ? ? "") + ")", "background: #37528C; color: #FFAD33"), "running" !== this.audioState() && (this.container.style.visibility = "hidden", await new Promise((e => {
                    window.setTimeout((() => {
                        e()
                    }), 200)
                })), this.container.style.visibility = ""), this.unmuteAudioContext(), !this.loadedConfig || this.loadedConfig.autoplay === u.On || this.loadedConfig.autoplay !== u.Off && "running" === this.audioState()) {
                if (this.play(), "running" !== this.audioState()) {
                    this.loadedConfig && this.loadedConfig.unmuteOverlay === d.Hidden || (this.unmuteOverlay.style.display = "block"), this.container.addEventListener("click", this.unmuteOverlayClicked.bind(this), {
                        once: !0
                    });
        ...
        destroy() {
            this.instance && (this.instance.destroy(), this.instance = null, this.metadata = null, this._readyState = sn.HaveNothing, console.log("Ruffle instance destroyed."))
        }
        checkOptions(e) {
        ...
        confirmReloadSave(e, n, t) {
            if (this.isB64SOL(n) && localStorage[e]) {
                ...
                if (a.includes(o) && e.startsWith(r)) {
                    return void(confirm(Re("save-reload-prompt", {
        ...
        populateSaves() {
            ...
            e.textContent = "", Object.keys(localStorage).forEach((n => {
                ...
                if (t && a && this.isB64SOL(a)) {
                    ...
                    s.className = "save-option", s.id = "download-save", s.title = Re("save-download"), s.addEventListener("click", (() => {
                    ...
                    c.htmlFor = "replace-save-" + n, c.className = "save-option", c.id = "replace-save", c.title = Re("save-replace"), u.addEventListener("change", (e => this.replaceSOL(e, n))), l.appendChild(u), l.appendChild(c);
                    const d = document.createElement("TD"),
                        f = document.createElement("SPAN");
                    f.className = "save-option", f.id = "delete-save", f.title = Re("save-delete"), f.addEventListener("click", (() => this.deleteSave(n))), d.appendChild(f), r.appendChild(o), r.appendChild(i), r.appendChild(l), r.appendChild(d), e.appendChild(r)
                }
            }))
        }
        async backupSaves() {
        ...
        virtualKeyboardInput() {
            const e = this.virtualKeyboard,
                n = e.value;
            for (const e of n)
                for (const n of ["keydown", "keyup"]) this.element.dispatchEvent(new KeyboardEvent(n, {
                    key: e,
                    bubbles: !0
                }));
            e.value = ""
        ...
        showContextMenu(e) {
            ...
            if ("contextmenu" === e.type ? (this.contextMenuSupported = !0, document.documentElement.addEventListener("click", this.hideContextMenu.bind(this), {
                    ...
                    once: !0
                }), e.stopPropagation()), [!1, h.Off].includes(this.loadedConfig ? .contextMenu ? ? h.On) || this.isTouch && this.loadedConfig ? .contextMenu === h.RightClickOnly || this.contextMenuForceDisabled) return;
            ...
            for (const e of this.contextMenuItems())
                if (null === e) this.contextMenuElement.appendChild((0, w.jsx)("li", {
                    ...
                    if (this.contextMenuElement.appendChild(r), !1 !== a) {
                        ...
                        this.contextMenuSupported ? (r.addEventListener("click", e), r.addEventListener("contextmenu", e)) : r.addEventListener("pointerup", e)
                    }
                }
        ...
        panic(e) {
            ...
            if (e instanceof Me) {
                const n = this.loadedConfig ? .openInNewTab,
                    t = this.loadedConfig && "url" in this.loadedConfig ? new URL(this.loadedConfig.url, document.baseURI) : void 0;
            ...
            t.push(this.getPanicData()), _e(this.container, n, t, this.swfUrl), this.destroy()
        }
        addOpenInNewTabMessage(e, n) {
            ...
            i.innerText = Re("open-in-new-tab"), i.onclick = () => e(t), o.appendChild(i), r.appendChild(o), a.appendChild(r), this.container.prepend(a)
        }
        ...
        displayMessage(e) {
            ...
            o.id = "continue-btn", o.textContent = Re("continue"), r.appendChild(o), t.appendChild(r), n.appendChild(t), this.container.prepend(n), this.container.querySelector("#continue-btn").onclick = () => {
        ...
        displayClipboardModal(e) {
            ...
            n && (n.textContent = Re("clipboard-message-description", {
        ...
        setMetadata(e) {
            this.metadata = e, this._readyState = sn.Loaded, this.hideSplashScreen(), this.element.dispatchEvent(new CustomEvent(on.LOADED_METADATA)), this.element.dispatchEvent(new CustomEvent(on.LOADED_DATA))
        }
    }
    var sn;
    ...
    var hn, vn = function(e, n, t, a) {
            ...
            if ("function" == typeof n ? e !== n || !a : !n.has(e)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
        ...
        gn = function(e, n, t, a, r) {
            ...
            if ("function" == typeof n ? e !== n || !r : !n.has(e)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    ...
    class bn extends HTMLElement {
        ...
        constructor() {
            super(), hn.set(this, void 0), gn(this, hn, new on(this, (() => this.debugPlayerInfo()), (e => {
                try {
    ...
    class Rn extends bn {
        ...
        static isInterdictable(e) {
            ...
            return o === "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase() ? !Array.from(e.getElementsByTagName("object")).some(Rn.isInterdictable) && !Array.from(e.getElementsByTagName("embed")).some(kn.isInterdictable) : !o && qe(r, t)
        }
        static fromNativeObjectElement(e) {
            const n = Ye("ruffle-object", Rn),
                t = document.createElement(n);
            for (const n of Array.from(e.getElementsByTagName("embed"))) kn.isInterdictable(n) && n.remove();
            for (const n of Array.from(e.getElementsByTagName("object"))) Rn.isInterdictable(n) && n.remove();
            return wn(e, t), t
        }
        get height() {
            return this.getAttribute("height") || ""
    ...
    class xn {
        ...
        install(e) {
            const n = new zn(e),
                t = this.__mimeTypes.length;
            this.__mimeTypes.push(n), this.__namedMimeTypes[e.type] = n, this[n.type] = n, this[t] = n
        }
        item(e) {
    ...
    const En = window.RufflePlayer ? .config ? ? {},
        Cn = function(e) {
            let n = Fe ? .href ? ? "";
            return !De && "publicPath" in e && null !== e.publicPath && void 0 !== e.publicPath && (n = e.publicPath), "" === n || n.endsWith("/") || (n += "/"), n
        }(En) + "ruffle.js";
    let An, qn, Fn, Dn;

    function Pn() {
        try {
            An = An ? ? document.getElementsByTagName("object"), qn = qn ? ? document.getElementsByTagName("embed");
    ...
    function On() {
        Fn = Fn ? ? document.getElementsByTagName("iframe"), Dn = Dn ? ? document.getElementsByTagName("frame"), [Fn, Dn].forEach((e => {
            for (const n of e) {
                ...
                try {
                    "complete" === e.document.readyState && $n(e, t)
                } catch (e) {
                    De || console.warn(t + e)
                }
    ...
    async function $n(e, n) {
        ...
        if (De || void 0 === t.documentElement.dataset.ruffleOptout)
            if (De) e.RufflePlayer || (e.RufflePlayer = {}), e.RufflePlayer.config = { ...En,
                ...e.RufflePlayer.config ? ? {}
            };
            else if (!e.RufflePlayer) {
            const n = t.createElement("script");
            n.setAttribute("src", Cn), n.onload = () => {
                e.RufflePlayer = {}, e.RufflePlayer.config = En
    ...
    function Mn() {
        ! function(e) {
            ...
            "install" in navigator.plugins && navigator.plugins.install || (Object.defineProperty(window, "PluginArray", {
                value: jn
            }), Object.defineProperty(navigator, "plugins", {
                value: new jn(navigator.plugins),
                writable: !1
            })), navigator.plugins.install(e), !(e.length > 0) || "install" in navigator.mimeTypes && navigator.mimeTypes.install || (Object.defineProperty(window, "MimeTypeArray", {
                value: xn
    ...
    function In() {
        ("favorFlash" in En && !1 === En.favorFlash || "ruffle.js" === (navigator.plugins.namedItem("Shockwave Flash") ? .filename ? ? "ruffle.js")) && (Pn(), On(), new MutationObserver((function(e) {
            e.some((e => Array.from(e.addedNodes).some((e => ["EMBED", "OBJECT"].includes(e.nodeName) || e instanceof Element && null !== e.querySelector("embed, object"))))) && (Pn(), On())
        })).observe(document, {
            childList: !0,
            subtree: !0
        }))
    ...
    try {
        if (void 0 !== document.currentScript && null !== document.currentScript && "src" in document.currentScript && "" !== document.currentScript.src) {
            let e = document.currentScript.src;
            e.endsWith(".js") || e.endsWith("/") || (e += "/"), Wn = new URL(".", e)
        }
    } catch (e) {
        console.warn("Unable to get currentScript URL")
    }! function(e, n = {}) {
        let t;
        window.RufflePlayer instanceof s ? t = window.RufflePlayer : (t = new s(window.RufflePlayer), window.RufflePlayer = t), t.sources[e] = Tn, Tn.options = n, !1 !== (!("polyfills" in t.config) || t.config.polyfills) && Tn.pluginPolyfill()
    }("local", {
        onFirstLoad: () => {
            r.p = function(e) {
                let n = Wn ? .href ? ? "";
